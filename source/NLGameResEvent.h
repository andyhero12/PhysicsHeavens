...
#ifndef NLGameResEvent_h
#define NLGameResEvent_h

#include <cugl/cugl.h>
using namespace cugl::physics2::net;
using namespace cugl;

class GameResEvent : public NetEvent {
...
public:
    ...
    static std::shared_ptr<NetEvent> allocGameResEvent(Vec2 pos);
