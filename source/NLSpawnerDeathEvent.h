...
#ifndef NLSpawnerDeathEvent_h
#define NLSpawnerDeathEvent_h

#include <cugl/cugl.h>
using namespace cugl::physics2::net;
using namespace cugl;

class SpawnerDeathEvent : public NetEvent {
...
public:
    ...
    static std::shared_ptr<NetEvent> allocSpawnerDeathEvent(Vec2 pos);
