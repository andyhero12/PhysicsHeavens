...
#ifndef NLShootEvent_h
#define NLShootEvent_h

#include <cugl/cugl.h>
using namespace cugl::physics2::net;
using namespace cugl;

class ShootEvent : public NetEvent {
...
public:
    ...
    static std::shared_ptr<NetEvent> allocShootEvent(Vec2 pos, float ang);
