...
#ifndef NLRecallEvent_h
#define NLRecallEvent_h

#include <cugl/cugl.h>
using namespace cugl::physics2::net;
using namespace cugl;

class RecallEvent : public NetEvent {
...
public:
    ...
    static std::shared_ptr<NetEvent> allocRecallEvent(Vec2 pos, bool isHost);
